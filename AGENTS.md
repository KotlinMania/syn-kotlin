...
This file is the quick-reference operating contract for syn-kotlin. The longer
...
syn-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`syn`](https://crates.io/crates/syn). Upstream Rust is the behavioral oracle while the

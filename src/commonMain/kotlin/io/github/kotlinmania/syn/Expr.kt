...
public sealed class Expr : ToTokens {
 ...
 public data class Macro(val attrs: List<Attribute>, val mac: io.github.kotlinmania.syn.Macro) : Expr() {
  override fun toTokens(tokens: TokenStream) {
   for (attr in attrs) attr.toTokens(tokens)
   mac.toTokens(tokens)
  }
...
public sealed class RangeLimits : ToTokens {
 public data class HalfOpen(val token: io.github.kotlinmania.syn.token.DotDot) : RangeLimits() {
  override fun toTokens(tokens: TokenStream) {
   token.toTokens(tokens)
  }
 }
 public data class Closed(val token: io.github.kotlinmania.syn.token.DotDotEq) : RangeLimits() {
  override fun toTokens(tokens: TokenStream) {
   token.toTokens(tokens)
  }
 }
...
public sealed class PointerMutability : ToTokens {
 ...
 public data class Mut(val token: io.github.kotlinmania.syn.token.Mut) : PointerMutability() {
  override fun toTokens(tokens: TokenStream) {
   token.toTokens(tokens)
  }
 }

 ...
 * // angle brackets in:
 * //
 * //     fun f<T : Clone, 'a, 'b : 'a, const N : usize>() { ... }
 * //
...
public sealed interface Peek : Lookahead.Sealed {
     ...
     *
     * In upstream Rust this is an associated function on the `Token` trait
 ...
 *
 * Upstream Rust defines this as `pub enum TokenMarker {}` — an uninhabited
